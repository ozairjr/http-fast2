...
const startServer = (port, minThreads, maxThreads) => {
    ...
    const httpServer = new HttpFast(threads, maxThreads || threads, __ROOT_DIR__, resources.routesFilePath, resources.middlewaresFilePath, resources.afterRequestFnFilePath)
    httpServer.go(port)
}
