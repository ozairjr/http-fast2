...
const startServer = (port, minThreads, maxThreads) => {
    ...
    const httpServer = HttpFast.startServer(threads, maxThreads, __ROOT_DIR__, resources.routesFilePath, resources.middlewaresFilePath, resources.afterRequestFnFilePath)
    httpServer.go(port)
}
